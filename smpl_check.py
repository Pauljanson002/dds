...
class DDS_SMPL():
    def __init__(self) -> None:
        ...
        self.hmar.to("cuda")
        self.betas = torch.randn(1,10,device="cuda",requires_grad=True)
...
def main(args):
    ...
    # wandb.init(
    #         project="collosal", name=args.name,mode=args.wandb_mode ,config=vars(args)
    #     )
    ...
    optim = torch.optim.SGD([dds_smpl.betas],lr=0.02)
